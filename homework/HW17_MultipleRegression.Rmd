...
This model could be helpful for covering elections, especially on a local level. You could examine the demographics of a the city or general are that is your beat for example, and then use this model to help predict how many people in that area will turn out to vote for an upcoming election. This information also could be used for a story about which demographic factors are correlated with lower turnout, and talk to people to explore different reasons why certain people do not vote. I suppose this model could also be used retrospectively to cover if a voting district exceeded turnout expectations set by the model in a certain election. 
