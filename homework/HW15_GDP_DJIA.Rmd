...
Both the coefficent and scatterplot show a strong relationship between the DJIA and the GDP. The correlation coefficient is at 0.95 which is very close to one, indicating a very strong positive correlation between DJIA and GDP. The line of best fit on the scatterplot shows that as GDP increases, the DJIA increases as well.
