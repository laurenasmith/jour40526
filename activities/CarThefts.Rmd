...
The distribution is positively skewed to the right. One standard deviation below the mean is roughly 8.4 while one standard deviation above is roughly 16.95. Roughly 67.7% of the data falls between these two values.
