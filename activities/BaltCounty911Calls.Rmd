...
The greatest outliers occur in early October, as well as New Year's Day. Spring levels are consistently high. There is a notable drop around January 2023 at the end of the graph. 
...
The unusually low data points show that there is a general pattern of decrease in the later months of 2022 going into 2023. The unusually high data points show that the consistently higher call counts are in both Spring and Summer.
...
The day with the highest number of calls is Tuesday, October 2022. This is an outlier, and particularly odd, given that Tuesdays have a relatively lower average number of calls compared to the average number of calls on the weekends. 23 calls, the number recorded on this Tuesday in October, is more than double the average amount of calls per day recorded in this year.
...
I definitely think that the two close dates in July are interesting, as they do suggest a bad/laced batch of fentanyl or some other drug that was causing overdoses. I also think that one of the highest dates being New Year's Day is interesting, I would want to see if I could compare it to other years to see if this is an enduring trend, or if New Year's Day in 2023 was just generally an outlier.
