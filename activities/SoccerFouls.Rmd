...
Both the correlation and the scatterplot show that there is no correlation between fouls and goal differential.
...
This shows that there is a correlation between shot attempts and goal differential.
